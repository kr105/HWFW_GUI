...
static void ListFileHeader(HWND hListView)
{
  ...
  ListView_AddItemW(hListView, ItemIndex(nIndex), 1, wsTemp, LT_NONE, 0, 0, 0);
  ListView_AddItemW(hListView, ItemIndexPlus(nIndex), 2, L"FileCRC32        #  File CRC32  (Little-Endian)", LT_NONE, 0, 0, 0);
  ...
  ListView_AddItemW(hListView, ItemIndex(nIndex), 1, wsTemp, LT_NONE, 0, 0, 0);
  ListView_AddItemW(hListView, ItemIndexPlus(nIndex), 2, L"HeaderCRC32      #  Head CRC32  (Little-Endian)", LT_NONE, 0, 0, 0);
  ...
  ListView_AddItemW(hListView, ItemIndex(nIndex), 1, wsTemp, LT_NONE, 0, 0, 0);
  ListView_AddItemW(hListView, ItemIndexPlus(nIndex), 2, L"ItemCount        #  Item information count  (Little-Endian)", LT_NONE, 0, 0, 0);
  ...
  ListView_AddItemW(hListView, ItemIndex(nIndex), 1, wsTemp, LT_NONE, 0, 0, 0);
  ListView_AddItemW(hListView, ItemIndexPlus(nIndex), 2, L"ItemSize         #  Project information size  (Little-Endian)", LT_NONE, 0, 0, 0);
  ...
  ListView_AddItemW(hListView, ItemIndex(nIndex), 1, wsTemp, LT_NONE, 0, 0, 0);
  ListView_AddItemW(hListView, ItemIndexPlus(nIndex), 2, L"Reserved         #  Reserved  (Little-Endian)", LT_NONE, 0, 0, 0);
}
...
static void ListProductInfo(HWND hListView)
{
  ...
  ListView_AddColumn(hListView, 512, 1, L"Matched product name");
  ...
  while (*lpStr != 0)
  {
    ...
    if (*lpTmp == ';')
    {
      ...
      if (blInterface == FALSE)
      {
        ...
        ListView_AddItemA(hListView, ItemIndexPlus(nIndex), 1, ";;;  WEB Interface  ;;;", LT_MODELINFO, 0, 0, 0);
      }
    }
    ...
    if (blInterface)
    {
      ...
      if (strcmp(lpTmp, "E8C") == 0)
        ...
        ListView_AddItemA(hListView, ItemIndexPlus(nIndex), 1, "HuaWei WEB Interface", LT_MODELINFO, 0, 0, 0);
        ...
        ListView_AddItemA(hListView, ItemIndexPlus(nIndex), 1, "Unknown Interface", LT_MODELINFO, 0, 0, 0);
    }
    else
    {
...
void ListItemInfo(HWND hListView)
{
  ...
  ListView_AddColumn(hListView, 112, 4, L"Item CRC32");
